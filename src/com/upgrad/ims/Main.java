...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //PRINTING TICKET DETAILS FOR REGULAR TICKET
        System.out.println("Printing Regular Ticket Details");
        System.out.println("PNR NUMBER: " +printTicketDetails(regularTicket1));

        //PRINTING TICKET DETAILS FOR TOURIST TICKET
        System.out.println("Printing Tourist Ticket Details");
        System.out.println("PNR NUMBER: " + printTicketDetails(touristTicket));
    }
